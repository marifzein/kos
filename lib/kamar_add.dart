...
class KamarAdd extends StatefulWidget {
  KamarAdd({
    Key? key,
  }) : super(key: key);

  @override
  State<KamarAdd> createState() => _KamarAddState();
}

class _KamarAddState extends State<KamarAdd> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          "kamar_add.dart" + MyGlobalVariables.userName,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              //fasilitas
              Text(
                'Fasilitas Kamar (AC, Fan, KM dalam dsb)',
                style: const TextStyle(
